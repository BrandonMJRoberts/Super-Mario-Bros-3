...
// Rendering boundary 
#define BACKGROUND_SPRITE_RENDER_WIDTH  18.0
#define BACKGROUND_SPRITE_RENDER_HEIGHT 12.0
...
#define PLAYABLE_SCREEN_AREA_HEIGHT ((BACKGROUND_SPRITE_RENDER_HEIGHT / 4.0) * 3.0)
