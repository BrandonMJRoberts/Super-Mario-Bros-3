...
public:
	...
	ObjectCollisionHandleData        SetIsCollidedWith(TwoDimensionalCollision collisionData) override { Notify(SUBJECT_NOTIFICATION_TYPES::COIN_COLLECTED, ""); return ObjectCollisionHandleData(true, false, false, false); }
