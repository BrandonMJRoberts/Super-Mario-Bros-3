...
public:
	...
	ObjectCollisionHandleData SetIsCollidedWith(TwoDimensionalCollision collisionData) override { return ObjectCollisionHandleData(true, false, false, false, false); }
